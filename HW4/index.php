...
$jobs = [
    [
        "name" => "Доблестный защитник родины",
        "beginDate" => "декабрь 2019",
        "endDate" => "декабрь 2020",
        "description" => "Не, ну а что такое?) 2000 тоже зарплата)",
    ],
    [
        "name" => "Директор магазина МТС",
        "beginDate" => "июль 2018",
        "endDate" => "октябрь 2019",
        "description" => "Проработал больше года в МТС)",
    ],
    [
        "name" => "Школьник",
        "beginDate" => "сентябрь 2007",
        "endDate" => "июнь 2018",
        "description" => "Да, это не работа, просто так добавил)))",
    ],
];
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($jobs); $i++): ?>
            <div class="w3-container">
              ...
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]["beginDate"]; ?> - <span
                  class="w3-tag w3-teal w3-round"><?php echo $jobs[$i]["endDate"]; ?></span></h6>
